function address_modal(person_id) {
  ...
  $.ajax({
      ...
      $('#edit_address_form').append($('<div><button type="submit" class="address_modal_btn" id="edit_submit" name="edit_submit" data-dismiss="modal">Submit</button><button data-dismiss="modal" class="address_modal_btn">Cancel</button></div>'));
