    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div id="modal-portfolio" class="container">
                <p class="exp-heading">Front End Developer - July 2015 to February 2016</p>
                  <p class="exp-body">
                    I worked as the Front End Developer for <em>Main Street Power Mail</em>, a Carmel, Indiana company that sells leads to insurance companies.  I used JavaScript, jQuery, HTML5, and CSS3 to dynamically create an elegant, responsive front end experience.  In addition, I did back end work with MySQL using PHP and Ruby on Rails.
                  </p>
                <p class="exp-heading">PHP Developer - March 2015 to July 2015</p>
                <p class="exp-body">
